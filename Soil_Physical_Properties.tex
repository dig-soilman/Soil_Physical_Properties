...
\begin{figure*}
    \centering
    \includegraphics[width=0.8\columnwidth]{images/TextureTriangle.png}
...
\begin{figure*}
    \includegraphics[width=0.9\columnwidth]{images/Texture_by_feel_analysis_DecissionTree-bw-72dpi.png}
...
\begin{figure*}
    \includegraphics[width=0.9\columnwidth]{images/Texture_by_feel_analysis_DecissionTree-5-Category-bw-72dpi.png}
