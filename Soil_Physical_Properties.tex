...
\caption{Texture-by-Feel Analysis decision flow chart to determine one of the twelve basic textural classes. The resulting determination of a textural class would be said to be an "apparent texture". Note that Silt is not on the tree.} \label{fig:TextureByFeelFlowChart12}
\end{figure*}
