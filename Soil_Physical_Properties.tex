...
% \usepackage[version=4]{mhchem} % provides commands for typesetting chemical molecular formulae and equations. Using siunitx instead of mhchem
...
% ToDo dig-soilman: Find a TiKz coded rendering of the Gibbs Diagram Textural Triangle
