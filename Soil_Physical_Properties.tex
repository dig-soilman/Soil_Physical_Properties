...
\begin{figure}
    ...
    \caption{image of Creative Commons Attribution-ShareAlike 4.0 International}
    \label{fig:by-sa}
\end{figure}
...
% TODO dig-soilman: populate an objectives section. Might the CSSE Performance Objectives be listed?
...
% ToDo dig-soilman: Find a TiKz or R coded rendering of the Gibbs triangle/ Textural Triangle with 12 classes

% ToDo dig-soilman: Find a TiKz or R coded rendering of the Gibbs triangle/textural triangle with 5 classes

% ToDo dig-soilman: Find a TiKz or R coded rendering of the Gibbs triangle/textural triangle with family particle size class overlay

% dig-soilman: it would be beneficial to have the Gibbs 12 category diagram and an overlay of the Family Particle Size Classes as an overlay to help natural resource majors to see that the Family Particle Size Classes are NOT the typically referred to "textures." In particular Agronomists and Crops folks struggle with differentiation of the two until they achieve advanced degrees. 
    
\begin{figure*}
    \centering
    \includegraphics[width=0.8\columnwidth]{images/Textural_Triangle-72pxpin-698x628px.png}
...
\begin{figure*}
    ...
    \caption{Texture-by-Feel Analysis decision flow chart to determine one of the twelve basic textural classes. The resulting determination of a textural class would be said to be an "apparent texture". Note that Silt is not on the tree.}
...
Post secondary High School FFA Land Judging teams determine a texture from the five general textural subgroup list for placing soils in a significantly simplified technical classification patterned after \textit{Land Capability Classification}. The \textit{general texture groups} are frequently further divided as five \textit{general texture subgroup(s)} and these general textural subgroup terms are also not the same as the basic textural classes. A modified decision tree to choose a subgroup term is presented in a texture-by-feel decision flow diagram Figure \ref{fig:TextureByFeelFlowChart5class}.
...
\end{figure*}
 ...
 High-school FFA Land Judgers learn and employ the five general texture \textit{subgroups} wherein \textbf{\textit{fine}} is the correct general textural subgrouping term for the twelve basic textural class categories of \textit{clay}, \textit{sandy clay}, and \textit{silty clay}. The term \textit{fine} and the general textural group term \textit{clayey} actually includes the same basic textural class categories \textit{clay}, \textit{sandy clay}, and \textit{silty clay}. Similarly, the \textit{sand} and \textit{loamy sand} classes from the twelve basic category system become \textbf{\textit{coarse}} from the general texture subgrouping, or \textit{sandy} from the general texture grouping. Figure \ref{fig:TextureClass12-5-3} depicts these relationships graphically.


    
 \begin{figure*}
    \includegraphics[width=1.0\columnwidth]{images/Textural_Classes_et_groupings_labeled-600dpi.png}
...
% ToDo dig-soilman alter the Textural_Classes_3-systems_bw-25pct-72pxpin-1013x1150px.png names from USDA 3 class textural classes to USDA 3 general texture groups; USDA 5 class textural classes to USDA 5 general texture groups: USDA 12 textural classes to USDA 12 basic textural classes
...
% TODO dig-soilman: when water and biological texts are written, and if they are included with this text, the below paragraph can be edited to cite directly.
...
\begin{figure}
   ...
   % \includegraphics[width=1.0\columnwidth]{images/2048px-Munsell-system.svg.png}
    ...
    \caption{A diagram of the Munsell Color System. The image shows i) the neutral values in steps of 1 from 0 to 10 in a virtical orientation, ii) a circle of 10 hues at value 5 and chroma 6, and iii) the chromas of purple-blue in steps of 2 from 0 to 12, at value 5. From Rus 2007 Creative Commons Attribution-Share Alike 3.0 Unported.}
...
Rus, J. 2007. The Munsell color system. Creative Commons Attribution ShareAlike3.0 license. [https://commons.wikimedia.org/wiki/File:Munsell-system.svg](https://commons.wikimedia.org/wiki/File:Munsell-system.svg)
