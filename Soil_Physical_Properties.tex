% The eventual copyright will be Donald G. McGahan 2022 v. 01 Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0) and this needs to be incorporated into the docuemnt in the title page and then perhaps in a footer?
...
\usepackage[=v3]{siunitx} % comprehensive (si) units package and overleaf chokes on [=v3]
...
The five size classes for granular and platy structures are \qty{< 1}{\mm}, \qtyrange[range-units = single]{1}{< 2}{\mm}, \qtyrange[range-units = single]{2}{< 5}{\mm}, \qtyrange[range-units = single]{5}{< 10}{\mm}, and \qty[]{\geq 10}{\mm}.

The six size classes for columnar, prismatic, wedge are \qty[]{< 10}{\mm}, \qtyrange[range-units = single]{10}{< 20}{mm}, \qtyrange[range-units = single]{20}{< 50}{\mm}, \qtyrange[range-units = single]{100}{< 500}{\mm}, and \qty[]{\ge 500}{\mm}. Note that these structures have this additional larger size class of extremely coarse.

The five size class for angular and subangluar blocky and lenticular structure are \qty[]{< 5}{\mm}, \qtyrange[range-units = single]{5}{< 10}{\mm}, \qtyrange[range-units = single]{10}{< 20}{\mm}, \qtyrange[range-units = single]{20}{< 50}{\mm}, and \qty[]{\ge 50}{\mm}.
...
\textbf{\textit{Macrovoids}} are \textgreater{} \qty{75}{\micro\metre} and was chosen utilizing empirical data wherein tensions of $\leq$ \qty{40}{\centi\metre} ($\leq$ \qty{-4}{kPa}) led to greater percolation rates. The emptying of macrovoids also leads to air exchange within the soil.  
...
\textbf{\textit{Microvoids}} \qtyrange{5}{30}{\micro\metre} and \textbf{\textit{ultramicrovoids}} \qty{0.1}{}\textemdash \qty{5}{\micro\metre} are are voids most responsible for storage of water that is available to plants, as the habitat for microorganisims, and soil fauna.  
...
When discussing pores it is frequently useful to group pores by the classes of void diameter(s) where macro- is applied to voids with a diameter greater than \num{> 0.075}{\milli\metre} and micro- having a diameter \num{< 0.075}{\milli\metre}. The use of void diameters is useful because water and air move relatively rapidly through the voids connected together that are effectively \num{> 0.075}{\milli\metre}\textemdash{}macropores\textemdash{} and much slower through smaller voids connected together that effectively \num{< 0.075}{\milli\metre} and thus then termed  micropores. Still, the continuity of void diameter in soil are generally not linear especially when a portion of the connected voids has a section of microvoids and this inter-connectivity between varying diameter voids impacts the movement of the fluids: air and water.
...
Soil color determination is accomplished by matching soil to color chips in The Munsell Book of Color. Color is communicated in a letter and number combination. These describe three parts of color: hue, value, and chroma such as 10YR 5/4. \textit{Hue} is the dominant spectral wavelength such as the colors of the rainbow (ROYGBIV). Soil is frequently in the red-orange-yellow range.  A 10R represents \qty{100}{\percent} whereas a 5Y represents \qty{75}{\percent} yellow and \qty{25}{\percent} red. \textit{Value} is the lightness of color. A value of 0 would be lowest lightness and 10 would be the lightest. \textit{Chroma} is the relative purity, intensity or strength of the hue. A chroma of 0 is pure black, grey, or white (hue dependent).
...
Soil drainage class is a way of communicating internal soil drainage conditions together with the depth in the soil that reducing conditions were, or are, prevalent (as determined by soil morphological features). There are seven such classes. The soil is examined to a depth of \qty{150}{\centi\metre}.

\textbf{\textit{Excessively drained}}: Water is removed very rapidly (gravelly or coarse sand textures). The occurrence of free water is very deep (\textgreater{}\qty{150}{\centi\metre} or 60\,in). Free of mottling related to wetness.

\textbf{\textit{Somewhat excessively drained}}: Water is removed from the soil rapidly (sands and loamy sand textures). The occurrence of free water commonly is very deep (\textgreater{}\qty{150}{\centi\metre} or 60\,in). Free of mottling related to wetness.

\textbf{\textit{Well drained}}: Water is removed readily but not rapidly. Free water occurrence is deep (\textgreater{}\qty{150}{\centi\metre} or 60\,in). Well drained soils are generally free of mottles related to wetness in the upper \qty{150}{\centi\metre} (or 60\,in). There may be mottles deeper in the soil profile.

\textbf{\textit{Moderately well drained}}: Water is removed from the soil somewhat slowly during some periods of the year. Free water occurrence is moderately deep (\qtyrange{50}{100}{\centi\metre}) and transitory (\numrange{1}{3} months) to permanent (continuous). The soils are wet for only a short time within the rooting depth during the growing season. Moderately well drained soils may have mottles below a depth of \qty{50}{\centi\metre} (about\,20 in.). It is common for moderately well drained soils to have a slowly permeable layer within or immediately beneath the solum or a relatively high water table.

\textbf{\textit{Somewhat poorly drained}}: Water is removed slowly so that the soil is wet at a shallow depth for significant periods during the growing season. The occurrence of free water is shallow (\qtyrange{25}{50}{\centi\metre} or 10 to 20\,in.) and transitory (1 to 3 months) or common (present 3 to 6 months). Wetness markedly restricts the growth of many common crop plants unless artificial drainage is provided. They commonly have a high water table, and mottles occur below a depth of \qty{25}{\centi\metre} (about 10\,in.). These soils often have thick dark A horizons high in organic matter.

\textbf{\textit{Poorly drained}}: Water is removed so slowly that the soil is wet at shallow depths periodically during the growing season or remains wet for long periods. The occurrence of free water is shallow or very shallow (\textless{}\qty{25}{\centi\metre} about 10 in.) and common (\numrange{3}{6} months) or persistent (6 through 12 months). Free water is commonly at or near the surface long enough during the growing season so that mesophytic crops cannot be grown without artificial drainage. These soils are commonly gleyed rather than redoximorphic  because they remain anoxic for long periods.
...
% Donald G. McGahan: Reaction section is to be populated by an ever-so-brief description of reaction as  historically discernible as sour versus chalky when placed in the mouth. Today placing soil in ones mouth is generally discouraged and there are relatively inexpensive ways to determine reaction class that are also more amenable to placing the soil in more classes that have more interpretive meaning. 

% Donald G McGahan: Reaction section will also hint that more detail is warranted and to expect more detail in the Chemical and Mineralogy Book/Chapter.
 
 \section{Effervescence}
 \label{effervescence}
 
 % Donald G McGahan: How to determine while describing a soil and the classes presented in in succinct fassion.



% Postscript content

% Donald G McGahan: An possible add-on as an appendix, or supplement, would be definitions for each of the consistence classes. Not sure about them being presented as a definition list or tabular. This would not be necessary to learners at all institutions but some might find the inclusion helpful.

% DGM ToDo Example study questions construction is a potential add-on. The down side is that as of 2022 the propensity for the solutions to such questions on study boards negates there effectiveness. 
